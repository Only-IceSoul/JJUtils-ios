...
typedef enum {
    ...
    INTERSECT_SK_CLIPOP,
    UNION_SK_CLIPOP_OP,               //!< union (inclusive-or) the two regions
    XOR_SK_CLIPOP_OP,                 //!< exclusive-or the two regions
    REVERSE_DIFFERENCE_SK_CLIPOP_OP,  //!< subtract the first region from the op region
    REPLACE_SK_CLIPOP_OP
} sk_clipop_t;
